...
for ((name, script) in mapOf(
    ...
    "checkMoveExecutions" to "tools/check-move-executions.mjs",
    "checkAbilityQueries" to "tools/check-ability-queries.mjs",
    "checkEncounters" to "tools/check-encounters.mjs",
    "checkBodyScale" to "tools/check-body-scale.mjs",
    "checkNativeProjection" to "tools/check-native-projection.mjs",
    "checkStageTransfer" to "tools/check-stage-transfer.mjs",
