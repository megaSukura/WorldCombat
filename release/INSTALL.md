...
电属性伙伴的 G 菜单提供独立的供能工作，选中 FE 接收机器后会走近供能。安装 Create 后，受控伙伴提供曲柄正反转子菜单；选中手摇曲柄开始工作，菜单可停止。两项都不依赖配招、不会消耗 PP；遇敌暂停，改令结束旧工作。JEI 中相应物品的说明页提供用途提示。

Cobblemon 牧场中的已加载自有宝可梦也可进入 WorldCombat 指挥：在牧场列表点击个体，或在 G 面板的“切换伙伴”中选择牧场个体。牧场原生的权限、召回、数量和活动边界继续生效。

牧场所在区块正常模拟时，伙伴可在主人离线、远离或处于其他维度时继续自主行动和工作；卸载后暂停，重新加载后恢复。玩家指令仍检查原生所有权和活动边界。
