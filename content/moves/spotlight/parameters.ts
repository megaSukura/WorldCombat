 ...
 *
 * 世界化：把一束光从手里打出去钉在一个生物身上。被照亮者**无处可躲**：落在它身上的伤害更重，
 *   而且它成为全场焦点——与它敌对的周围生物会被指向它（world.target），把「只瞄准它」的意思落成实际行为。
 *   目标可选友方或敌方：照敌人＝集火标记，照队友＝引火并接受它也会被打得更痛。光束沿施法者与目标画出来。
 *
 * 数值来源（每个参数读不同的个体数据）：
 ...
 *   sweepRadius 光束扫过的范围：基础 4 格 + 身高×0.8，夹 3..7；体型越大，被转向它的周围生物越多。
...
namespace PokemonSkills {
    ...
    export const spotlightFriendText = "world_combat.move.spotlight.text.friend";
    ...
    actionParameters.define(spotlightId, {
        ...
        sweepRadius: formula(
            ...
            "扫过范围", { unit: " 格", description: "聚光扫过的范围；体型越大，能被转向被照者的周围生物越多。" }),
        motes: formula(
