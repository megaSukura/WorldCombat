    ...
    moments: {
        gather: {
            ...
            emitters: [
                ...
                {
                    name: "foam", bind: "source", offset: [0, 0.05, 0],
                    ...
                    color: 0xCFEBFF, alpha: [0.7, 0], light: "full", maxParticles: 50
                }
            ]
        },
        rise: {
            ...
            emitters: [
                ...
                },
                {
                    ...
                    color: 0xCFEBFF, alpha: [0.7, 0], light: "world", maxParticles: 140
                }
            ]
        },
        surge: {
            ...
            emitters: [
                {
                    ...
                    direction: "up", speed: [0.12, 0.4], spread: 24,
                    lifetime: [7, 13], size: [0.44, 0.06], sizeMode: "index",
                    color: 0xFFFFFF, alpha: [1, 0], light: "full", bloom: 0.4
                },
                {
                    name: "splash", bind: "target", offset: [0, 0.25, 0], height: 0.25,
                    ...
                    direction: "up", speed: [0.16, 0.5], spread: 12,
                ...
                },
                {
                    ...
                    direction: "up", speed: [0.1, 0.34], spread: 26,
                    gravity: 0.03, drag: 0.9,
        ...
        fall: {
            ...
            emitters: [
                {
                    name: "runoff", bind: "source", offset: [0, -0.3, 0], height: 0,
                    particle: "world_combat_core:cobblemon/generic/water/waterjet",
                    rate: 12, shape: { kind: "sphere", radius: 0.3 },
                    direction: "down", speed: [0.08, 0.26],
                    gravity: 0.03, drag: 0.92,
                    lifetime: [6, 11], size: [0.12, 0.02],
                    color: 0xCFEBFF, alpha: [0.6, 0], light: "world", maxParticles: 70
                }
            ]
        },
        spill: {
