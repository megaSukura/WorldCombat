...
namespace PokemonSkills {
    define({
        ...
        name: "Power Gem",
        description: "把光收进一枚宝石般的焦点，射出一条又细又长、会贯穿的宝石光线：线路上每个敌人都被依次射穿，越远分到的光越少，每个击点崩出一枚碎晶。光走直线、被方块挡住，所以掩体是它唯一的空门；不选敌人也能朝任意方向空射，或用它把两敌之间摆成一条线。",
        uses: ["在长距离点名一个远处的目标", "把光贯穿一条线上的敌人", "逼对手躲到掩体后才敢露头", "对着空地或两敌之间摆线自由开火"],
        kind: "aim",
        range: 12,
        maxRange: 18,
        prepare: 13,
