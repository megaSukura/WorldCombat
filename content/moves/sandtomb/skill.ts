...
namespace PokemonSkills {
    ...
    define({
        id: "sandtomb",
        name: "Sand Tomb",
        description: "把一片沙甩到目标脚下，地面塌成流沙坑：贴地的目标被钉住、往坑心收、往下沉，沙砾一遍遍磨它，地表留下一片沙化的地面。只有升空才能脱身——跳跃、飞行、被抬起或瞬移都会滑脱。沉陷式坑更深更久、收得更紧，但磨得更轻；速陷式磨得更重、收拢更松、更快结束。",
        uses: ["把地面上的重目标拖住往坑里埋", "封住一片地面不让对手站住", "用物理持续伤害磨厚目标", "让起跳或飞行成为对手唯一的选择"],
        kind: "enemy",
        range: 10,
        maxRange: 17,
        prepare: 9,
