...
namespace PokemonSkills {
    ...
    define({
        ...
        name: "Ancient Power",
        description: "把大地的原始之力从脚下按开：一圈古能半球把周围（含空中）的敌人一起轰开、向外推开并向上托起，地面浮起地缘符文；散开的余波有概率把自身五项战斗能力各抬一级。深源式窄而重、更稳；广域式宽而快、推得更远。",
        uses: ["被围住时一次轰开一圈人", "连空中的目标一起罩住，不只是地面", "用反哺把五项战斗能力在短时反哺期间提高"],
        kind: "self",
        range: 3.4,
        maxRange: 5.6,
        prepare: 11,
