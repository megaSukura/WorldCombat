 ...
 *   散开的余波有概率灌回自身，把全部能力各抬一级。它连空中的目标一起罩住——古力不是地震。
 *
 * 三幕：
...
namespace PokemonSkills {
    ...
    define({
        id: "ancientpower",
        name: "Ancient Power",
        description: "把大地的原始之力从脚下按开：一圈古能半球把周围（含空中）的敌人一起轰开、向外推开并向上托起，地面浮起地缘符文；散开的余波有概率把自身全部能力各抬一级。深源式窄而重、更稳；广域式宽而快、推得更远。",
        uses: ["被围住时一次轰开一圈人", "连空中的目标一起罩住，不只是地面", "用反哺把全部能力一点点拉起来"],
        kind: "self",
        range: 3.4,
        maxRange: 5.6,
        prepare: 11,
        ...
        execute: function (action, move, config, done) {
            ...
            if (world.random() < chance) {
                ...
                WorldFeedback.text(world, at.plus(WorldCombat.point(0, self === null ? 1.4 : self.height() + 0.1, 0)),
                    ancientpowerSurgeText, [stages], 30);
