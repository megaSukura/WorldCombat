...
namespace PokemonSkills {
    ...
    define({
        id: "appleacid",
        name: "Apple Acid",
        description: "扔出一颗酸苹果：命中时炸成酸浆，主目标与落点周围的敌人都会掉特防；带着发酵身份的目标再挨一颗会更狠（−2）。落点留下一滩冒泡的酸浆，敌人走进去会被浸到发酵、留在里面会被反复咬。发酵式更黏更易叠酸，爆汁式一发更痛、溅得更开。",
        uses: ["对同一个目标连扔两颗：第一颗特防 −1，命中发酵中的目标再降 2 级", "一次溅到聚在落点周围的多个对手", "用余下的酸浆封住一小片地"],
        kind: "enemy",
        range: 10,
        maxRange: 15,
        prepare: 10,
