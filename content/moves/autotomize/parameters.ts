 ...
 *
 * 翻译：把「削掉身体上没用的部分」翻成**当场卸下外壳**——身上一块块没用的甲片被撬下来甩出去，
 *   身体一下子轻了、快得离谱；轻身窗口里重力变小，跳得更高、落得更慢。取原生「+2 速度、15 PP、体重变轻」；
 *   放弃回合制里永久保留的等级 → 即时交战里速度等级立刻写入公共能力阶梯，卸下的外壳是短寿命的临时实体，
 *   轻身窗口内重力下调（这是「变轻」在世界里的兑现，也是它的形状）。
 *   本族里它是唯一会真的改变身体重感、并且外壳抛落后自行散掉（不产生可拾取资源）的一招。
 *
...
namespace PokemonSkills {
    actionParameters.define("autotomize", {
        ...
        buoyancy: percent(
            ...
            "轻身浮力", "轻身窗口内重力下调的比例；身体越沉卸完越轻，跳得越高、落得越慢。它不保证静止悬浮。"),
        /** 卸件速度：越宽甩得越开。 */
        fling: formula(
        ...
        lightTicks: seconds(
            ...
            "轻身窗口", "「轻身」在身上留多久；等级越高越久。窗口内重力下调、跳得更高落得更慢，AI 也不会重复施放。"),
        /** 起手：越沉撬得越久。 */
        tempo: seconds(
