 ...
 * **苹果下落本身**：施法者把一颗大苹果送到目标正上方 `dropHeight` 格处松手（实际高度受目标头顶真实空间限制），
...
namespace PokemonSkills {
    actionParameters.define("gravapple", {
        ...
        dropHeight: formula(
            ...
            "释放高度", {
                unit: "格",
                description: "苹果被送到目标头顶多少格处再松手；个子高、等级高的人拎得更高。实际高度还受目标头顶可用空间限制，天花板下只落得到容得下的高度。"
            }),
        ...
        slam: formula(
            ...
            "下落冲量", {
                unit: "格/刻",
                description: "苹果追上离地目标时，额外把多重的下坠加在它身上（把它砸回地面）；身体越沉砸得越重。这是原生受击冲量，抗击退强的目标可能完全不被压下，但伤害与压碎仍照常结算。"
            })
    });
