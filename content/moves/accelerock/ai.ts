 ...
 *   残血且 `ai.finish`（默认开）+14，用这一下把残血撞飞；破阵式开启时贴在一起的多个目标各自独立参与排序。
 * 够不到怎么办：射程由 `charge` 决定，共享任务把身位收进冲刺距离后再撞。
 * 放完之后：目标被顶开、落点留下碎石疤；交回共享交战计划，破阵式一次撞穿一排。
 */
namespace PokemonSkills {
    ...
    addPreferences(accelerockId, {}, [
        field(pathOf("breakthrough"), "破阵式", "boolean", {
            help: "开启：沿冲刺线一路碾过去（最多 2 个，极快时 3 个）、每个落点都留碎石疤；代价是每一下 ×0.85、顶开 ×0.7、起手 +2 刻、收招 +3 刻、冷却 +6 刻。关闭：撞上第一个就停，这一下最重、顶得最远。"
        }),
