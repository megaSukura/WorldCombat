...
Smoke.scenario("rollout", function (stage) {
    ...
    stage.until(1200, function () {
        ...
        stage.after(60, function () {
            ...
            stage.note("each pass rolls 2^chain damage, capped at 5 passes; a whiff or any other committed move clears the chain, and a hit knocks the foe away so the caster must close in again", {
