...
Smoke.scenario("magicpowder", function (stage) {
    ...
    stage.until(420, function () {
        ...
        stage.after(90, function () {
            stage.note("魔法粉把目标当前的全部属性改写成单一超能力（共享 NativeModifiers types 层，到期自动还原原生属性），并挂上共享身份的超能力标记。草属性生物会把粉抖掉、完全免疫；纯超能力的目标也撒不上去（预检直接拒绝）。属性是否真的带上超能力、改写时长、命中与否由共享结算决定，留给完整装配的人工试玩。改写时长随等级与特防、粉粒数随特攻、闪点数随等级、粉团半径随体型分别变化。", {
