...
namespace PokemonSkills {
    ...
    describe(nightmareId, [
        ...
        { key: "description.1", values: ["nightTicks", "shades", "sealRadius"] },
        ...
        { key: "growth.0", values: ["tier.0.level", "tier.0.shades"] },
        { key: "growth.1", values: ["tier.1.level", "tier.1.shades", "tier.1.drain", "tier.1.reach"] }
    ]);
}
