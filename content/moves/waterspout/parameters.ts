 ...
 *
 * 翻译：把「掀起潮水」落成一道**会沿地面推进的潮墙**——水先在地上兜起来（起手），再整圈推进：
 *   推涌式的潮头从中心往外扫，回卷式从外缘往中心收，两端都覆盖；潮头扫过谁，谁就挨一次浪、按实际方向
 *   被推走或被拉近、浇得湿透；水还把身上的火浇熄。满血时水势最大，越虚弱越小。与同族分开：喷火是瞬时
 *   内向外的爆发、点着人；巨龙威能是一道前向龙息；喷水是唯一**会移动、会推／拉人、会浇灭、会留下湿身**
 *   的一招。下雨时全场的水都更足，它跟着变强（读世界天气）。
 *
 * 数据分散（每项读不同的精灵数据）：
