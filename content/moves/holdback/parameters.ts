 ...
 * 留手由每次伤害自带的 `minimumHealth: 1` 实现：宿主在该次原生 hurt 的所有 Pre 监听者之后截断生命减量，
 * 只对本次挥扫生效，仍沿原生吸收链，不保护目标免受其他攻击。
 *
 ...
 *   angle  扇形张角：碰撞箱宽度定这一扫张开多大（总张角），判定与画面共用它。
...
namespace PokemonSkills {
    actionParameters.define("holdback", {
        ...
        /** 扇形张角：50 + 宽度偏移[−5,20] + 沉腰 8；夹 35..78（总张角）。 */
        angle: formula(
            F.base(50)
            ...
            "扇形张角", {
                base: 50, unit: "度",
                description: "横扫张开的总角度；判定与画面共用它，身体越宽扫面越宽，沉腰式再张开一点，能同时罩住更多目标。"
            }),
