 ...
 * 数：`data.embers`（速度与物攻派生）决定火星与爆火的密度，`data.intensity`（本次伤害派生）决定命中强度，
 * `data.burn`（1 表示目标被点着）决定命中核心是否多一圈燃烧辉光，`data.ratio` 决定冲锋进度亮度。
 */
        ...
        charge: {
            ...
            emitters: [
                ...
                },
                {
                    ...
                    color: 0xF2601E, alpha: [0.75, 0], light: "full", bloom: 0.35, maxParticles: 130
                },
                {
            ...
            emitters: [
                {
                    ...
                    color: 0xC03818, alpha: [0.6, 0], light: "full", bloom: 0.2, maxParticles: 150
                },
                {
            ...
            emitters: [
                {
                    ...
                    color: 0xFFE8A0, alpha: [1, 0], light: "full", bloom: 0.6
                },
                {
            ...
            emitters: [
                {
                    ...
                    color: 0xC03818, alpha: [0.8, 0], light: "full", bloom: 0.3, maxParticles: 70
                },
                {
            ...
            emitters: [
                {
                    ...
                    color: 0xC03818, alpha: [0.65, 0], light: "world", maxParticles: 50
                }
            ]
        }
    }
