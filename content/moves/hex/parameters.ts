...
namespace PokemonSkills {
    ...
    actionParameters.define(hexId, {
        ...
        sigil: formula(
            ...
            "结界半径", {
                unit: "格",
                description: "画在锁定落点的诅咒结界有多大；特攻越高、对手身板越大，圈得越开。连环式铺得更广。"
            }),
        ...
        crawl: formula(
            ...
            "诅咒爬行速度", {
                unit: "格/刻",
                description: "诅咒飞向锁定落点的速度；它决定鬼火头多久抵达、首波涌刺发生在第几刻，也决定飞行表现快慢。"
            }),
        ...
        reach: formula(
            ...
            "施放距离", {
                unit: "格",
                description: "诅咒能送到的最远距离，也是本招的实际射程来源；出手快的个体够得更远。"
            }),
