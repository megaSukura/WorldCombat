 ...
 * 摔打 / slam —— 可执行设计说明。
 *
 * 场面：一只只会摔打的精灵对一只 NoAI 的铁傀儡——目标站住不动，落痕扬起后不会跑掉，
 * 用来核对「落痕固定 + 落下结算」。夜晚、晴天，伤害只可能来自这一砸。
 * 必然事实：本招被提交过；目标受到过伤害（落痕条带里有人）。
...
Smoke.scenario("slam", function (stage) {
    ...
    stage.until(900, function () {
        ...
        stage.after(30, function () {
            ...
            stage.note("the crit roll and how many times the scar caught the golem are random", {
