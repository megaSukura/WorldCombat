...
namespace PokemonSkills {
    ...
    define({
        ...
        name: "Slam",
        description: "把长尾、长身或藤蔓高高扬起，朝对手当时站的地方狠狠摔下去。扬起的瞬间砸点就定死了——圆形落点会在地面亮出来，站住不动就吃满，在落下前挪开就能躲掉。它是全族最高的单发，也是最慢、最容易落空的一记。",
        uses: ["对站桩或刚被定住的目标砸下全族最重的一记", "预判落点把堵在门口的目标震开", "在被缠住的目标身上补一记收割"],
        kind: "enemy",
        range: 3.0,
        maxRange: 4.2,
        prepare: 11,
