...
namespace PokemonSkills {
    actionParameters.define("peck", {
        ...
        /** 啄落速度：0.45 + 体重偏移[0,0.2] ×0.001；俯冲 ×1.2；夹 0.3..0.95。 */
        plummet: formula(
            ...
            "啄落速度", {
                unit: "格/刻",
                description: "目标离地时被喙尖勾住往下压的初速；越重的个体压得越狠。目标随后按重力落回地面。"
            }),
    ...
    describe("peck", [
        ...
        { key: "description.1", values: ["reach", "beak", "feathers"] },
