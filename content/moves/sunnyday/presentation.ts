 ...
 * 大晴天 / sunnyday 的客户端表现。
 *
 * 一句话：施法者头顶聚起一圈暖光、把太阳请下来 → 一柱金光砸在落点、铺开成一大片晒着的光尘与日耀 →
 ...
 * 持续状态：field 是贴地的暖金光尘与缓慢上浮的日耀，低密度、低 alpha，铺满烈日区但不遮视线；
 * 地面一圈金环画出「站哪里会被晒到」。
 ...
 * burst  光尘 sparkle/glowingsparkle_yellow 上浮 0.10-0.03 16-28 0.6→0 ≤360
    ...
    moments: {
        ...
        burst: {
            ...
            emitters: [
                ...
                { name: "column", bind: "point", offset: [0, 9.5, 0], height: 0,
                    particle: "world_combat_core:cobblemon/generic/fire/ember",
                    burst: { count: { data: "density", fallback: 30 }, interval: 2, repeats: 18 },
                    shape: { kind: "circle", radius: 2.4 },
                    direction: "down", speed: [0.16, 0.3], drag: 0.97,
                    lifetime: [14, 26], size: [0.10, 0.03],
                    color: 0xFFE09A, alpha: [0.7, 0], light: "full", bloom: 0.25, maxParticles: 400 },
