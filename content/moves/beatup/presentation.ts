 ...
 * 围攻 / beatup 的客户端表现。
 *
 * 一句话：施法者脚下先翻起一圈召集的暗影 → 每只同伴脚边立起一道暗色影子、依次扑向目标，撞出一撮暗色碎屑 →
 *   最后一团暗雾散开。
 * 色相家族：暗紫 0x6E5AA8 画群影，近黑 0x2E2340 画暗雾，苍白高光 0xB9A6E0 只给撞击那一下。
 * 起击收：起 muster 20t ／ 集 gather 20t ／ 扑 rush 每道暗影一条轨迹 ／ 击 hit 20t ／ 收 scatter 24t。
 * 范围：召集半径是一块真的区域，gather 的贴地环半径直接读 `data.scale`（本招算出的 rally 与 crowd 派生）；
 *   玩家看得出「站在这一圈里的同伴会一起上」。
 * 运动：rush 的发射器绑 `data.projectile` 跟随每道暗影本体；暗影沿同伴到目标的方向走，机制里的 arrival 与它同步。
            ...
            emitters: [
                {
                    ...
                    color: 0x6E5AA8, alpha: [0.9, 0], light: "full", bloom: 0.3, maxParticles: 80
                },
                {
            ...
            emitters: [
                {
                    ...
                    color: 0xB9A6E0, alpha: [1, 0], light: "full", bloom: 0.4, maxParticles: 48
                },
                {
                    ...
                    color: 0x6E5AA8, alpha: [0.8, 0], light: "full", maxParticles: 20
                }
            ]
        },
        whiff: {
            ...
            emitters: [
                {
                    ...
                    color: 0x2E2340, alpha: [0.4, 0], light: "world", maxParticles: 16
                }
            ]
        },
        scatter: {
