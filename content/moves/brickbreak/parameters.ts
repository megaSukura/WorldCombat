 ...
 *   反射壁、光墙与极光幕。Cobblemon 1.8，308 位学习者。
 * 核心念头：一步踏进，一记手刀自上而下劈在目标身上；刀锋落在哪，那一片真实可达的屏障就被震碎。
 *   不要求先命中身体：只要刀锋落下，落点视线可达的整块屏障网络就先碎；空点也能拆防护区，普通方块不动。
 *
 * 数值分散（每个参数读不同的个体数据）：
...
namespace PokemonSkills {
    actionParameters.define("brickbreak", {
        ...
        wardBreak: formula(
            ...
            "碎壁半径", {
                unit: "格",
                description: "刀锋落点周围、且从落点视线可达的屏障会被震碎；被屏障护住的一整簇目标都会一起失去反射壁、光墙与极光幕，物攻越高震得越远。"
            }),
