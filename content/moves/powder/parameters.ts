 ...
 *
 * 世界化：把「预先撒粉、等火引爆」落成一记**朝瞄准方向抛出的陷阱**——施法者朝瞄准点抛出一团粉尘，
 *   第一碰到的对手会被沾上（草属性直接穿过）。之后它自己放出火攻（脚本火招，或烈焰人等原生物种真正造成
 *   第一笔对外火伤）时，身上的粉尘就当场炸开一次，对它造成一段按施法者特攻定级的自伤。它和粉系四式不同：
 *   毒粉／麻痹粉／催眠粉是命中即施加状态，而粉尘是**先埋一颗、等对手自己点火**。
 *
    ...
    actionParameters.define("powder", {
        ...
        blast: percent(
            F.base(0.22).plus(F.stat("specialAttack").minus(60).times(0.0008).clamp(-0.03, 0.06))
                ...
                .clamp(0.15, 0.30),
            "爆炸伤害", "粉尘被它自己的火攻引燃时，对被撒上的对手造成其最大生命多少比例的自伤；特攻越高爆得越重，易爆式再放大三成。"),
