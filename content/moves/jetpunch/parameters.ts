 ...
 *   若它正带着火或灼伤，这一拳的水把火浇熄。选取用 `kind: "aim"`：朝方向或世界点都能打，近敌只是辅助朝向，
 *   提交后可对空挥拳；明确选中着火的同伴时改为**无伤浇灭**（只洗火、不造成伤害），默认方向的友方不会被误伤。
 *   它与音速拳同为「不位移的直拳」，区别是拳上裹着一条水柱：打得更远、更重、会浇湿对手；它也是全族唯一的拳（punch）水招。
 *   与水流喷射分开：水流喷射是把自己整个裹进水柱冲出去；喷射拳站着不动，水柱只裹拳，靠水花读出来，还能替同伴灭火。
 *
