 ...
 * 修正方向追向目标；命中处沿**弹体实际入射的竖直面**切出一个十字，把目标钉在交点上，只有真正落在
 * 十字两道亮笔上的近旁敌人才各挨一记刃风。空点直射可用，不挂空 homing；墙会把弹与刃风都挡下。
...
namespace PokemonSkills {
    ...
    actionParameters.define(psychocutId, {
        ...
        arc: formula(
            ...
            "十字半径", {
                unit: "格",
                description: "命中处切出的十字两道亮笔有多长，也是刃风能扫到的范围；高大的个体切得更开。"
            }),
        ...
        echo: percent(
            ...
            "波及比例", "真正落在十字两道亮笔段厚内、且不是主目标的敌人，各保留几成威力；等级越高扫得越实，凝刃式再高一档。"),
        ...
        radius: formula(
            ...
            "刃判定半径", {
                unit: "格",
                description: "月牙飞行时扫过的横向判定半径，也是两道十字亮笔的段厚；身板越宽的个体掷出的刃越大。"
            }),
