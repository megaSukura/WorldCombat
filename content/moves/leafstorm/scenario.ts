 ...
 * 必然事实：本招被提交过（`stage.casts`）；目标受到过伤害（风柱卷到它、叶刃炸开）。
 * 命中率（原生 90 折成风柱写偏）、自身特攻下降的具体级数、卷叶式是否开出叶场，都写进 note 供读轨迹判断。
 */
Smoke.scenario("leafstorm", function (stage) {
    ...
    stage.until(1400, function () {
        ...
        stage.note("风暴命中、自身特攻下降级数与叶场属于设计事实；私有装配没有读取原生特攻等级的断言原语，由完整装配的人工试玩核对", {
