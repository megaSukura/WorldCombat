 ...
 *
 * 一句话：身侧浮起骨影与阴气，掷出的骨棒拖着一圈幽紫灵魂尾迹飞向目标，命中处炸开一团阴气，被慑住的目标头上
 * 再冒一层鬼火。
 * 色相家族：幽紫与近黑（impact_ghost／obscuringsmoke 原色、shadowball_impact）＋一处冷白高光（glowingsparkle）。
 * 拍子：起（windup 骨影成形）→ 击（throw 骨棒尾迹 → impact 阴气炸开）→ 收（wail 慑防鬼火）。
 * 范围：impact 在命中点炸开的团就是骨棒的判定尺度；`data.scale` 与机制里的判定半径同源，骨棒越大炸得越开。
 * 运动：骨棒本体用物品外观（minecraft:bone）飞行，尾迹沿它的轨迹拖出；阴气从命中点朝外散，鬼火在目标身上慢慢收。
