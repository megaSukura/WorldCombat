...
const IcywindDefinition: ParticleDefinition = {
    ...
    moments: {
            ...
            emitters: [
                {
                    ...
                    shape: { kind: "polyline" },
                    rate: { data: "flow", fallback: 70 }, direction: "up", speed: [0.04, 0.16], spread: 12,
                    lifetime: [6, 13], size: [0.15, 0.03],
                    color: 0xBFE9FF, alpha: [0.8, 0], light: "full", bloom: 0.35, maxParticles: 220
                },
                {
                    name: "wall", bind: "path", offset: [0, 0, 0],
                    particle: "world_combat_core:cobblemon/generic/ice/icy_snow",
                    shape: { kind: "polyline" },
                    rate: { data: "flow", fallback: 60 }, direction: "up", speed: [0.02, 0.12], spread: 6,
                    lifetime: [8, 16], size: [0.2, 0.05],
                    color: 0xEAF9FF, alpha: [0.4, 0], light: "world", maxParticles: 200
                },
                {
                    name: "bank", bind: "path", offset: [0, 0.08, 0],
                    particle: "world_combat_core:cobblemon/generic/swirlingwind",
                    shape: { kind: "polyline" },
                    rate: { data: "flow", fallback: 50 }, direction: "up", speed: [0.02, 0.1], spin: 8,
                    lifetime: [10, 20], size: [0.24, 0.06],
                    color: 0xEAF9FF, alpha: [0.26, 0], light: "world", maxParticles: 180
                }
            ]
        },
        swept: {
        ...
        rimes: {
            ...
            emitters: [
                {
                    name: "sheet", bind: "path", offset: [0, 0.05, 0],
                ...
                {
                    name: "motes", bind: "path", offset: [0, 0.1, 0],
                    particle: "world_combat_core:cobblemon/generic/ice/icy_snow",
                    shape: { kind: "polygon" },
