 ...
 *   齿轮转一会儿就锁定，动力随即消散。资格在**施放这一刻只读一次**：当时合格又够得着的人才接上动力，
 *   之后放下工具、走出齿链范围也不会掉，直到动力真到期或被清除；施放后才合格的不会被补上。这是这招与
 *   磁场操控的分界：磁场是在地上留一片久一点的场、每遍扫描都管双防；辅助齿轮只在这一刻把攻势配送出去，
 *   接上的人**带着它走**。取原生「钢、物攻 +1／特攻 +1、目标己方、PP 20」。
 *
