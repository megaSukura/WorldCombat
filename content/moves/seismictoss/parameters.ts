...
namespace PokemonSkills {
    ...
    describe("seismictoss", [
        ...
        { key: "description.2", values: ["hurlXZ", "hurlUp", "slamDelay", "shockwave"] },
        ...
        { key: "growth.0", values: ["tier.0.level", "tier.0.shockwave"] },
        { key: "growth.1", values: ["tier.1.level", "tier.1.shockwave", "tier.1.pinTicks"] }
    ]);
}
