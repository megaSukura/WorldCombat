 ...
 * 求雨 / raindance 的客户端表现。
 *
 * 一句话：施法者头顶旋起一小团暗云、落下第一滴雨 → 云铺开成一大片雨幕，雨点斜着从区域上方砸下，
 * 落到有暴露的地面或屋簷就散掉、溅起环环涟漪 → 雨里的人身上炸开一串水花、真正被浇灭的火冒出一缕白汽。
 ...
 * 持续状态：field 是稀疏的斜雨与贴地涟漪，低饱和、贴地与高空各一层；雨点带碰撞，碰到第一层地面／遮挡即消失，
 * 地下不会被画成露天雨；雨幕虽稀但落点清楚，战斗中仍看得清目标。
 ...
 * burst  雨幕 rainsplash      斜向下落＋落地即散 0.10-0.03 16-28 0.55→0 ≤320
 * field  雨幕 rainsplash      斜向下落＋落地即散 0.08-0.02 14-26 0.38→0 ≤280
        ...
        burst: {
            ...
            emitters: [
                ...
                { name: "curtain", bind: "point", offset: [0, 11, 0], height: 0,
                    ...
                    collision: { bounces: 1, disappearAt: 1, horizontalSpread: 0.2, verticalBounce: 0 },
                    lifetime: [16, 28], size: [0.10, 0.03],
                    color: 0x6FB7E8, alpha: [0.55, 0], light: "full", maxParticles: 320 },
        ...
        field: {
            ...
            emitters: [
                { name: "curtain", bind: "point", offset: [0, 11, 0], height: 0,
                    ...
                    color: 0x6FB7E8, alpha: [0.38, 0], alphaMode: "sin", light: "full", maxParticles: 280 },
