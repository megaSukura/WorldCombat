 ...
 *   沿瞄准方向的水平分量高速推进，身后拖一整条水柱；撞上第一个非友方活体就炸开——结算 jet 接触伤害、
 *   把它沿喷射方向顶开，**成功命中后才**把它浇透（共享身份 world_combat:status/soaked，别的单元可以只问「湿没湿」）；
 *   若它正带着火或灼伤，这一冲把火浇熄（浇熄走共享的 burn 身份）。伤害被拒时不动对方原有的湿或火。
