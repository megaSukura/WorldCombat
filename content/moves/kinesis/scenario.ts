...
Smoke.scenario("kinesis", function (stage) {
    ...
    stage.until(800, function () {
        ...
        stage.note("kinesis bends a spoon over several ticks and needs line of sight throughout; a wall between the two, or the target leaving the gaze range, fizzles it", {
