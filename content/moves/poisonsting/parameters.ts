 ...
 *
 * 翻译：把「将有毒的针刺入对手」落成**一发廉价的远程细针**——飞得远、伤害极低、出手快、冷却短；可对空/对点直射，
 *   只有真的扎出伤害后，毒才由一个挂在该受击者身上的短命托管效果在伤口里慢慢渗开（stick → seep 两拍），
 *   所以玩家会看到「中针」与「中毒」是两件事，而飞针动作不等渗完就已经释放。它卖的是便宜与次数。
 *
