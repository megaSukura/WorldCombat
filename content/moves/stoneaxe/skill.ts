...
namespace PokemonSkills {
    ...
    define({
        ...
        name: "Stone Axe",
        description: "一记过顶的岩石斧劈下，岩石碎片悬浮在落点四周：走进这片空域的敌人被砸，飞在空中的也躲不掉。悬岩式让碎片持续悬浮、反复砸；崩解式第一次被闯进就整片崩下来砸一记重的。这一斧瞄准要害，暴击率高于普通招。",
        uses: ["近身一记斧劈，把悬浮岩留在对手周围", "惩罚怕岩的目标，连飞在低空的一起砸", "用崩解式在窄口砸出一记重的"],
        kind: "enemy",
        range: 3.2,
        maxRange: 4.6,
        prepare: 9,
