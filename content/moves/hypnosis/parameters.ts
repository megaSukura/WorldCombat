 ...
 *
 * 世界化：把「用暗示诱导睡意」翻成一记**从眼里放出去的暗示波**——施法者盯住目标，一圈圈暗示光环沿一条
 *   通视的直线真实飞过去，把睡意灌进它脑里。它不造成伤害，成败取决于意志对抗：施法者的特攻与等级压过
 *   目标的特防与等级时，才把对方拉进睡眠；压不过就只是让光环散在对方身上。途中撞墙或先撞到前景实体
 *   都会把波挡下，不会绕过它去够锁定者；朝空处释放时只送一波，不会自动挑人。
 *
 * 与同族分开：哈欠必中但睡意要等；恶魔之吻必须贴身。催眠术是唯一**隔空**的一条，代价是它最不牢靠；
...
namespace PokemonSkills {
    ...
    actionParameters.define(hypnosisId, {
        ...
        waveSpeed: formula(
            ...
            "波纹速度", {
                unit: " 格/刻",
                description: "暗示波沿直线真实飞过去的快慢；速度快的个体送得更急，敌人更难在波到之前走开。"
            }),
