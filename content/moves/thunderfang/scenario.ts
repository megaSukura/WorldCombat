 ...
 * 是否麻住（numbChance）、麻多久、是否咬懵、扑空还是咬中、暴击，
...
Smoke.scenario("thunderfang", function (stage) {
    ...
    stage.until(1400, function () {
        ...
        stage.after(60, function () {
            ...
            stage.note("numbChance and flinchChance are separate rolls; biting an already paralyzed target only brightens this contact's arcs and never roots it", {
