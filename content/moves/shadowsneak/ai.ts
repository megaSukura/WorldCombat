 ...
 *
 * 什么局面下出手：对手可见、敌对、还活着、身在地面（已知离地则不选），且在 `ai.maxChase`（默认 10）格内。
 *   它是全族最便宜的先制起手，沿地面探出的短影只认第一只踩上来的敌人；被掩体挡住、看不见的目标不选，
 *   不会隔墙点杀。更远交给共享接近逻辑走过去。
 * 对谁出手：当前威胁；不可见、友方、离地或已倒下的不接受。
 ...
 * 放完之后：第一只踩中影子的敌人背侧挨一刀；交回共享交战计划，适合接一记近身重招。
 */
