 ...
 * 范围：bore／drill 绑目标点，半径按 `data.scale`（判定半径 / 0.5）缩放；spin 是一条沿 `data.direction`
 *   的线，玩家一眼看出钻到哪、有多粗。
 * 运动：charge 的钻屑绕身体向内收成钻头；spin 的钢蓝气流沿方向拖尾、钻头自转；bore 的守护碎光从目标表面
 *   向外崩、钻屑受重力落下。
    ...
    moments: {
        ...
        bore: {
            ...
            emitters: [
                ...
                {
                    name: "shards", bind: "target", offset: [0, 0.5, 0], height: 0,
