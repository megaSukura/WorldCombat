 ...
 *   瞬间铺到线上第一个身体（或墙），把共享的麻痹身份按上去；它不造成伤害（原生威力 0），靠的是瞬时与可靠。
 *   因为它走直线，掩体和挡在中间的身体会把它拦下：躲在墙后，或让同伴站在线上，就能替目标吃掉这一记。
 *   它只点一个、但不会被走位甩掉：跑得再快也甩不开一条瞬间的直线，只能不给线或让自己免电。
 *   电属性招式的原生免疫也照算：地面属性把电流导进地里，这一记对它无效；麻痹免疫由共享门槛另行核对。
 *
...
namespace PokemonSkills {
    ...
    actionParameters.define(thunderwaveId, {
        ...
        joltSpeed: formula(
            ...
            "放电火花", {
                unit: "档",
                description: "放电时火花炸开的密度；速度快的个体放得更急、火花更密。"
            }),
