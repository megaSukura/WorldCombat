 ...
 *   powder（粉末类，草属性对粉末免疫）。
 *
 * 世界化：把「撒出催眠粉」翻成一团**抛出去、落地就不散的催眠尘云**——粉团可点地、点实体或只给方向抛出，
 *   首次撞块或撞活体都在真实落点炸开、空中飞尽也在前方散粉；落点摊开一片云，谁站在云里谁被一口口喂进
 *   睡意（先变慢、再睡下），睡意按口数有界累积、走出云外退一口后慢慢走完。它是四式里唯一一个
...
namespace PokemonSkills {
    ...
    actionParameters.define(sleeppowderId, {
        ...
        drowsyTicks: seconds(
            ...
            "睡意存留", "每一口睡意留下的变慢挂多久；走出云外睡意退一口，再按它慢慢走完，走出得早就能把睡意甩掉。"),
