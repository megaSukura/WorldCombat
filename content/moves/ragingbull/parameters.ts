 ...
 * 核心念头：低头压角，整副身板沿直线冲出去，撞开路上的一切；角尖撞在屏障上，整片屏障随冲势一起碎。
 *   它是全族唯一「人也在动」的一招：位移本身是武器，也是它和其他三招最大的区别。
 *
 * 数值分散（每个参数读不同的个体数据）：
 *   ram        冲撞威力：物攻给牛劲，速度给冲势，体重给质量。
 *   charge     冲锋距离：速度决定冲得多远，体重决定压得动多远。
 *   gallop     冲锋速度：速度决定每刻推进多快。
 *   collisionRadius 牛身半径：碰撞箱高度决定撞面多大。
 *   shove      顶开距离：体重决定把目标顶开多远。
 *   wardBreak  碎壁半径：体重决定这一冲震碎多广的一片屏障。
...
namespace PokemonSkills {
    ...
    actionParameters.define("ragingbull", {
        ...
        wardBreak: formula(
            ...
            "碎壁半径", {
                unit: "格",
                description: "冲势震碎屏障的范围；被屏障护住的一整簇目标都会失去反射壁、光墙与极光幕，越重的个体震得越广。"
            }),
