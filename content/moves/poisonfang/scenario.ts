 ...
 * 毒在咬后隔 pump 刻才渗开，届时目标要仍在口边且通视（toxicChance 决定剧毒还是普通中毒，原已中毒时确保剧毒），
 * 是否中毒/剧毒、咬空还是咬中、暴击，都是概率与站位结果，写进 note 供读轨迹判断。
 */
Smoke.scenario("poisonfang", function (stage) {
    ...
    stage.until(1400, function () {
        ...
        stage.after(80, function () {
            ...
            stage.note("the bite is an in-place short trace; the venom seeps in pump ticks later and only if the target is still at the mouth and in sight; toxicChance chooses toxic over plain poison, and an already poisoned target is upgraded for sure", {
