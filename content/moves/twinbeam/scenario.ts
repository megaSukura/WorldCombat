 ...
 *   两道的命中与暴击、共鸣还是并射、第一道命中后第二道的共鸣加成，都是随机或配置结果，写进 note 供读轨迹判断。
 */
Smoke.scenario("twinbeam", function (stage) {
    ...
    stage.until(1400, function () {
        ...
        stage.after(80, function () {
            ...
            stage.note("each beam rolls separately; in resonance form the second gains a bonus only if the first landed; crit is variable", {
