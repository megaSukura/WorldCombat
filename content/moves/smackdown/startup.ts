// 击落的贴地载体：借共享身份 world_combat:status/smackdown，同时以部分拘束身份 world_combat:status/partiallytrapped
// 供任意单元读取；行为（拔浮空、按地、落地）写在本单元 skill.ts。对宝可梦、原版生物、玩家是同一个状态效果：
// 物品栏可见、/effect 可用、牛奶可解。
