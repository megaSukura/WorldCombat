 ...
 *   再猛地放开，光浪以身体为中心铺成一个真实的 3D 光球：球内每个看得见中心、且与中心之间没有墙挡着的敌人都被闪到，
 *   离得越远越弱；被闪花眼的人脚下发虚、走得慢（状态被拒的控免目标照吃主伤，只是不减速）。
...
namespace PokemonSkills {
    actionParameters.define("dazzlinggleam", {
        ...
        radius: formula(
            ...
            "光浪半径", {
                unit: "格",
                description: "强光罩住身周多大的一个 3D 光球（空中地面一起算）；体型高、特攻强、等级高的个体铺得越开。它也是本招的实际射程与指示圈半径。墙会在实际遮挡上把光挡住，躲在墙后不吃这一下。"
            }),
