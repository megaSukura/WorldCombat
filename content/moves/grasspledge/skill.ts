...
namespace PokemonSkills {
    ...
    define({
        ...
        name: "草之誓约",
        description: "在选定地面立起一纸草之誓约：草柱炸土而出，柱内敌人被根须缠住、拖慢并暂时无法移动，柱脚留下一圈持续盘绕的誓约印。落点附近已有火或水的誓约印时共鸣——这一击更重，脚下变成火海（草＋火，持续点燃其中的敌人）或湿地（草＋水，踩进去会被陷住并重度拖慢）。",
        uses: ["在远处地面立起草柱并缠住敌人", "用一圈盘绕的誓约印拖慢一块地", "与火／水誓约连成火海或湿地"],
        kind: "point",
        range: 9,
        maxRange: 17,
        prepare: 10,
