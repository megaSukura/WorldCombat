...
namespace PokemonSkills {
    ...
    define({
        id: "whirlpool",
        name: "Whirlpool",
        description: "把一道水旋甩到目标脚下并锚在命中点：水旋不断把圈内的敌人朝涡心拽回、持续灌水，卷入者被拖慢。它不钉住谁，但谁也别想轻易离开那片水；被击退出圈外或水势耗尽就散去。滞水式更宽更黏更久但灌水更轻；急流式更紧更短、灌水更重。",
        uses: ["把想跑的目标一遍遍拽回交战区", "封住一条退路或门口", "用持续灌水磨掉难缠的近战目标", "靠减速让队友补上"],
        kind: "enemy",
        range: 11,
        maxRange: 18,
        prepare: 8,
