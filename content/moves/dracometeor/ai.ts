 ...
 * 对谁出手：`ai.spread`（默认开）打开时，身边挤着更多敌人的目标排前——流星式把落点铺成一片；
 *   目标贴得太近（小于 `ai.minRange`，默认 5 格）时排后，留着距离再砸更能发挥射程。
 * 够不到怎么办：reach 就是本招射程，不够就靠近。
 * 放完之后：一记高威力特殊龙并在落点留下坑；交回共享交战计划。
 */
namespace PokemonSkills {
    ...
    addPreferences("dracometeor", {}, [
        field(pathOf("barrage"), "流星式", "boolean", {
            help: "开启：召 count 颗陨石散布在目标周围逐个砸下，每颗威力 ×0.8、起手 +5 刻、冷却 +8 刻；人群里覆盖更好。关闭（坠星式）：一颗大陨石直落目标，单点更重、出手更快。"
        }),
