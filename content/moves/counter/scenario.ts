 ...
 *   这类来犯伤害没有作者类别，但由「造成者就是直接命中者」判定为物理，正好进账；AI 在账本为空时
 *   根本不会花 PP 空讨，先挨到第一记、记进账本之后才迎上去，把那笔以两倍打回僵尸。
...
Smoke.scenario("counter", function (stage) {
    ...
    stage.until(1000, function () {
        ...
        stage.note("the AI spends no PP until a fresh physical debt exists, so the first cast comes only after the zombie lands; the refund is twice the physical damage the caster actually took inside the window", {
