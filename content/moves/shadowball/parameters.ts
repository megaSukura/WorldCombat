 ...
 *
 * 翻译：把「掷出一团黑影攻击」落成一记直线高速飞行的实心暗影团。它在飞行途中不断剥落，命中活物时炸开
 * 成一圈阴气，并把那点特防一并卷走；触发时目标身上会短暂贴住一层散不去的影子。它是磨防四式里唯一
 * 用真实投射物飞行、只打单体、射程中等的那个：其余三式都在出手瞬间把范围铺出去。
 *
 * 数据分散（每项依赖不同的精灵数据）：
...
namespace PokemonSkills {
    ...
    describe("shadowball", [
        ...
        { key: "description.3", values: ["clingTicks", "shards", "pref.dense"] },
