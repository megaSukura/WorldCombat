 ...
 * 世界化：沙暴不是一片天，而是一团**会磨的沙**——施法者把地表的沙石卷起来、朝选定的那片砸下去，
 * 沙幕张开后贴地横扫：暴露在外的活体被一粒粒磨掉血（按趟结算 1/16 上下），并被风推着走；
 * 岩石之躯在沙里把沙砾嵌进裂缝、特防提高（Rock 特防 +1 级，出圈即散）；地面被磨出的沙留在原地一段时间。
