 ...
 *
 * 什么局面有意义：有可见威胁、在 ai.maxChase 以内、目标还没被迷住、宝可梦目标为异性、视线畅通。
 *   回眸只盯一个；献舞要圈里至少站着 ai.minOnlookers 个非友方，人越多越值得。
 * 对谁出手：当前威胁；同性宝可梦与已经被迷住的目标跳过。
...
namespace CompanionBehavior {
    PokemonSkills.addPreferences("captivate", { ai: { maxChase: 10, opening: "anytime", minOnlookers: 2, leaveStation: false } }, [
