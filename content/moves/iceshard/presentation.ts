            ...
            emitters: [
                {
                    ...
                    burst: { count: { data: "splinters", fallback: 12 }, at: 0 },
                    shape: { kind: "sphere", radius: 0.35 },
                    direction: "outward", speed: [0.04, 0.16],
                    gravity: 0.05, drag: 0.9,
                    lifetime: [8, 15], size: [0.07, 0.02], sizeMode: "index",
                    color: 0xD8E8F0, alpha: [0.4, 0], light: "world", maxParticles: 30
                },
                {
                    ...
                    color: 0xBFE8F8, alpha: [0.6, 0], light: "world", maxParticles: 16
                }
            ]
        }
    }
