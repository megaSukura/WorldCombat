// 大闹一番的可执行设计说明：一只只会大闹一番的火爆猴被两只贴身僵尸围住，一只在右前、一只在左后。
// 必然事实：本招被提交过；至少一只僵尸受到过伤害（扇扫罩住扫过去的一侧）；施法者身上出现过共享身份 confusion——
//   大闹完自己陷入恍惚是这一招固定的结局。连挥几次、哪一侧被扫到、是否磕伤自己写进 note 供读轨迹判断。
