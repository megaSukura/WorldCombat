 ...
 *
 * 一句话：身侧一道横斩光划过 → 血肉被甩出去、在脚边铺开一圈 → 身上浮起一层淡淡的红光，表示身体更轻更快。
 * 色相家族：血肉红 0xC0483A 为主体，暖白 0xFFD8C0 作斩光与细节，蒸汽用中性灰。
 * 拍子：起（windup 0–6t）→ 击（carve 1–18t）→ 收（afterglow 18–40t）。
 * 范围：carve 绑施法者自身，血肉向四周铺开的半径按 `data.scale`（散落半径 / 2）画出——铺多开就是甩出去多远。
 * 运动：横斩光扫过身体，血肉沿随机水平方向带重力抛出并落地，红光向上缓慢离场。
            ...
            emitters: [
                {
                    ...
                    lifetime: [20, 32], size: [0.16, 0.03], sizeMode: "sin",
                    color: 0xFF7A5A, alpha: [0.3, 0], alphaMode: "sin", light: "full", maxParticles: 20
                },
                {
                    name: "steam", bind: "source", offset: [0, 0.5, 0], height: 0.4,
                    particle: "world_combat_core:cobblemon/generic/smoke/smoke",
                    rate: 7, shape: { kind: "sphere", radius: 0.35 },
                    direction: "up", speed: [0.01, 0.04],
                    lifetime: [20, 30], size: [0.22, 0.05],
                    color: 0xE0D0C8, alpha: [0.22, 0], light: "world", maxParticles: 30
                }
            ]
        }
    }
