/**
 * 彗星拳的可执行设计说明：让会这一招的巨金怪（Metagross，真实学习者）冲进拳程、对一只僵尸砸下流星重拳。
 *
 * 必然事实：本招被提交过（`stage.casts`）；正面砸中并造成伤害（`damageTo`）。
 * 反哺是否触发（约 20% 起）、震开多人、焦坑的块数与形状都写进 note 供读轨迹判断；
 * 本场景只放一个目标，落点连震由完整装配的人工试玩核对。
 */
Smoke.scenario("meteormash", function (stage) {
    ...
    stage.until(1200, function () {
        ...
        stage.after(30, function () {
            ...
            stage.note("the ~20% attack-surge roll, how many foes the landing shock caught and the exact crater cells are random/positional", {
