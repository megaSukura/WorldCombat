 ...
 *   药水伤害是远程来犯，没有作者类别，但由「造成者不是直接命中者」判定为特殊，进账；AI 在账本为空时
 *   不会花 PP 空放镜面，挨到第一下、账本生效之后才把那笔以两倍射回女巫。
...
Smoke.scenario("mirrorcoat", function (stage) {
    ...
    stage.until(1000, function () {
        ...
        stage.note("the AI holds the mirror until a fresh special debt exists, so the first cast comes only after a potion lands; the refund is twice the special damage the caster actually took inside the window", {
