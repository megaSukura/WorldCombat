 ...
 *   地层钻到对手脚底，所以是地面属性、**不接触**。每一击只在落点留下一圈会散去的尘痕，不改动地表；最后一下最重。
 *   它是本族唯一把骨头离手、并让冲击从落点地面传开的招。自由点抛骨：可以点敌人，也可以只给一个世界点。
 ...
 *   crack      尘痕时长：等级决定落点尘痕散开多久；裂地式留得更久。
...
namespace PokemonSkills {
    ...
    describe(bonerushId, [
        { key: "description.0", values: ["quake","strikes"] },
