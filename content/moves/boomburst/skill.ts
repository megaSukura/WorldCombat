...
namespace PokemonSkills {
    ...
    define({
        id: "boomburst",
        name: "Boomburst",
        description: "憋住一口气再把声压整圈炸出去：身周所有敌人（空中地上一起）被轰中并被击飞，越靠近中心挨得越重、吹得越远；爆响在被轰到的人（包括施法者自己）耳中留下耳鸣。爆压式更窄更重、吹得更远。",
        uses: ["被围住时一次把一圈人轰开", "把贴身的追击者吹离原位", "打空中与地面都不挑的无差别扫场", "用一次高威力换取一段长起手"],
        kind: "self",
        range: 4.8,
        maxRange: 7.6,
        prepare: 18,
