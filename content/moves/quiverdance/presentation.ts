 ...
 *
 * 一句话：翅上先抖落几点鳞粉 → 舞者轻轻几拍，每一拍从身侧向外洒出一圈亮粉与花瓣似的鳞片 →
 * 鳞粉在身周悬停成一圈薄幕、慢慢飘转；散场时一起落下。
 ...
 * 范围：bloom 的地环绑脚点、fit none，半径按 `data.scale`（实际鳞幕半径 / 1.1）推出；veil 的环贴身体、半径绑 `data.veil`。
 * 运动：unfurl 鳞粉向身体收拢；flutter 向外洒、带重力缓落；veil 沿身周缓慢上浮绕转（低密度，让出视线）。
...
const QuiverDanceDefinition: ParticleDefinition = {
    ...
    moments: {
        ...
        bloom: {
            ...
            emitters: [
                {
                    name: "bloom_ring", bind: "point", fit: "none", offset: [0, 0.06, 0],
