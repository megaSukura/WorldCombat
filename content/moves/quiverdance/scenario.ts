 ...
 * 扬鳞拍数、是否厚幕、三项等级是否真的抬到 +1、窗口结束时收回多少，都写进 note 供读轨迹判断（私有装配没有
...
Smoke.scenario("quiverdance", function (stage) {
    ...
    stage.until(1200, function () {
        ...
        stage.after(80, function () {
            stage.note("flutter count, veil, the real Sp.Atk/Sp.Def/Speed stages and how much the window takes back are design facts read here; the private assembly has no reader for native stat stages", {
