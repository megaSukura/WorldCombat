...
Smoke.scenario("hyperfang", function (stage) {
    ...
    stage.until(1400, function () {
        ...
        stage.after(50, function () {
            ...
            stage.note("the bite always lands when the pounce connects; the sideways whip, the pin and the flinch roll all follow. The flinch tag records whether a shake landed and the target was displaced.", {
