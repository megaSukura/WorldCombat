...
namespace PokemonSkills {
    actionParameters.define("block", {
        ...
        /** 栅栏与压制窗口：120 + 防御 ×0.8 + 等级 ×1.2；撑臂 ×1.35；夹 90..320。 */
        hold: seconds(
            ...
            "封锁时长", "栅栏立着、以及贴住墙的敌人被压住的时长；防御与等级越高压得越久，撑臂再拉长。到期栅栏自己收回。"),
        /** 落栅钉住：10 + 速度 ×0.1；夹 8..24；只作用于贴住墙的敌人。 */
        pin: seconds(
            F.base(10).plus(F.stat("speed").times(0.1)).clamp(8, 24).round(0),
            "落栅钉住", "墙落下的那一下把贴住墙面的敌人短暂钉在原地多久；速度越快越突然。没贴住墙的目标不受影响。"),
        /** 落栅推挤：0.4 + 物攻 ×0.01；夹 0.2..1.0；只作用于贴住墙的敌人。 */
        shove: formula(
            F.base(0.4).plus(F.stat("attack").times(0.01)).clamp(0.2, 1.0).round(2),
            "落栅推挤", {
                unit: "格",
                description: "墙落下时把贴住墙面的敌人往术者方向推多远；物攻越高推得越实。没贴住墙的目标不受影响。"
            }),
