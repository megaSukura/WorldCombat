 ...
 * 玩泥巴 / mudsport 的客户端表现。
 *
 * 一句话：施法者把脚下的泥甩开 → 落点炸开一圈泥浆、泥泡贴地糊满一块地、地表翻成湿泥 →
 * 站进去的活体被泥糊住。
 * 色相家族：泥褐 0x6B4A2E 作主体、湿泥亮面 0x9C8460 作细节、灰绿 0x7A6B4F 作地表碎点；不用饱和色。
 * 起击收：起 windup 20t ／击 splash 48t ／持 field 每 5 刻续期 ／击 coat 22t。
 * 持续状态：field 是贴地滚动的泥泡与边圈，低密度、贴脚边，不遮视线；边圈画出「站哪会被糊上泥」。
 * 机制驱动：泥滩半径决定边圈与泥花的实际大小（data.scale = 半径/3.2），泥花数量直接读 mudDensity，
 * 落点翻起的泥量读实际盖住的格数 cells。
 *
    ...
    moments: {
        ...
        splash: {
            ...
            emitters: [
                ...
                { name: "bubbles", bind: "point", offset: [0, 0.1, 0], height: 0,
                ...
                { name: "mud", bind: "point", offset: [0, 0.05, 0], height: 0,
                    particle: "world_combat_core:cobblemon/generic/mud/mudsplash",
                    burst: { count: { data: "cells", fallback: 8 }, interval: 2, repeats: 5 }, shape: { kind: "circle", radius: 2.7 },
        ...
        field: {
            ...
            emitters: [
                ...
                { name: "bubbles", bind: "point", offset: [0, 0.08, 0], height: 0,
                    particle: "world_combat_core:cobblemon/generic/mud/mudbubble",
