 ...
 * 拍子：起（load 上磁）→ 发（launch 发射、seek 吸弹、stick 吸住）→ 击（blast 爆炸、splash 溅射）／空（fade）。
 * 范围：blast 的爆环半径由 `data.scale`（爆炸半径 / 1.2）给出，玩家看出这一炸罩住多大一圈。
 * 运动：seek 的钢弹沿 projectile 锚点被磁力拉向对手；stick 的炸弹随目标移动轻轻振动；blast 向外炸开。
...
const MagnetbombDefinition: ParticleDefinition = {
    ...
    moments: {
        ...
        stick: {
            ...
            emitters: [
                {
                    name: "stuck", bind: "target", offset: [0, 0.5, 0], height: 0.5,
                    particle: "world_combat_core:cobblemon/generic/orb/orb",
                    burst: { count: 3 },
                ...
                {
                    name: "fuse", bind: "target", offset: [0, 0.62, 0], height: 0.5,
