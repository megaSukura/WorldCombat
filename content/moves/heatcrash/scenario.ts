 ...
 * 高温重压的可执行设计说明。
 *
 * 场面：一只只会高温重压的重型精灵（Snorlax），面对 3 格外一只极慢、极轻的 Shuckle。两者开战，AI 只有这一招可用。
 * 必然事实：本招被提交过；目标被砸中并受到伤害。
 * 是否掷中点燃、落点换成了哪些方块、明火的观感，都是概率与位置结果，写进 note 供读轨迹判断。
 */
Smoke.scenario("heatcrash", function (stage) {
    ...
    stage.until(900, function () {
        ...
        stage.after(30, function () {
            ...
            stage.expect(stage.changedBlocks().some(function (b) { return b.after === "minecraft:magma_block"; }),
