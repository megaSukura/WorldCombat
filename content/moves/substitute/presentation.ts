 ...
 *
 * 一句话：一处微光在脚边收紧 → 落点炸出一具半透明的血盾剪影并立在那里 → 本体与替身之间拉着一根细线，
 * 每次被打中都在它身上弹开一小圈 → 超距/遮挡时细线崩断、回到视线时接回 → 打碎时向外抛散，或被时间收走时淡去。
 * 色相家族：骨白／冷灰为主（xsfadeorb、smallring、tinydust、smoke），只有承伤与成形强调用一点暗红。
 * 拍子：起（windup 0–8t）→ 击（form 1–20t）→ 收（present 持续 / absorb 每次承伤 / link_break、link_restore 变化时 /
 *      break、expire 20–30t）。
...
const SubstituteDefinition: ParticleDefinition = {
    ...
    moments: {
        ...
        present: {
            ...
            emitters: [
                {
                    name: "shield_link", bind: "path", fit: "none", offset: [0, 0.5, 0],
                    particle: "world_combat_core:cobblemon/generic/orb/xsfadeorblite",
                    rate: 9, shape: { kind: "polyline" }, direction: "shape", speed: [0.0, 0.02],
                    lifetime: [8, 14], size: [0.07, 0.02], sizeMode: "index",
                    color: 0xD9DCE6, alpha: [0.6, 0], light: "full", maxParticles: 44
                },
                {
        ...
        link_break: {
            ...
            emitters: [
                {
                    name: "snap_line", bind: "path", fit: "none", offset: [0, 0.5, 0],
                    particle: "world_combat_core:cobblemon/generic/sparkle/glowingsparkle",
                    burst: { count: 16, at: 1 }, shape: { kind: "polyline" },
                    direction: "shape", speed: [0.06, 0.22],
                    lifetime: [6, 11], size: [0.12, 0.02], sizeMode: "index",
                    color: 0xF0C6CE, alpha: [0.9, 0], light: "full", maxParticles: 60
                },
                {
                    name: "break_ring", bind: "point", offset: [0, 0.5, 0],
                    particle: "world_combat_core:cobblemon/generic/ring/smallring",
                    burst: { count: 10 }, shape: { kind: "sphere", radius: 0.3 },
                    direction: "outward", speed: [0.05, 0.16],
                    lifetime: [8, 13], size: [0.24, 0.06],
                    color: 0x9AA0B0, alpha: [0.5, 0], light: "world"
                }
            ]
        },
        link_restore: {
            ...
            emitters: [
                {
                    name: "restore_line", bind: "path", fit: "none", offset: [0, 0.5, 0],
                    particle: "world_combat_core:cobblemon/generic/sparkle/glowingsparkle",
                    burst: { count: 18, at: 1 }, shape: { kind: "polyline" },
                    direction: "shape", speed: [0.04, 0.16],
                    lifetime: [7, 12], size: [0.12, 0.02], sizeMode: "index",
                    color: 0xE8EAF2, alpha: [0.95, 0], light: "full", maxParticles: 60
                },
                {
                    name: "restore_ring", bind: "point", offset: [0, 0.5, 0],
                    particle: "world_combat_core:cobblemon/generic/ring/smallring",
                    burst: { count: 10 }, shape: { kind: "sphere", radius: 0.28 },
                    direction: "inward", speed: [0.04, 0.12],
                    lifetime: [9, 14], size: [0.24, 0.06],
                    color: 0xD9DCE6, alpha: [0.55, 0], light: "full"
                }
            ]
        },
        absorb: {
