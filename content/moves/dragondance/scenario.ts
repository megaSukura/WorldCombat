 ...
 * 只能先起舞；有威胁且在起舞距离内时，它会先盘旋再考虑交战。
 * 必然事实：本招被提交过；施术者身上出现过共享身份 world_combat:status/dragondance 的龙势窗口。
 * 盘旋圈数、是否高飞、攻速等级是否真的抬到 +1、窗口结束时收回多少，都写进 note 供读轨迹判断（私有装配没有
...
Smoke.scenario("dragondance", function (stage) {
    ...
    stage.until(1200, function () {
        ...
        stage.after(80, function () {
            stage.note("turns, soar, the real attack/speed stages and how much the window takes back are design facts read here; the private assembly has no reader for native stat stages", {
