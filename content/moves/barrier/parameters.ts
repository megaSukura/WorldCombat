 ...
 *
 * 翻译：把「制造坚固的壁障」翻成**真的在身前竖起一排硬光板**——用世界做材料，而不是只改数字。硬光板以
 *   `world.terrain` 租借成真实方块，挡住正面的通道与视线；板立着的时候，术者的防御等级也抬起来。
 *   取原生「防御 +2、PP 20、纯自我强化」；放弃回合制里永久保留的等级 → 即时交战里防御等级立刻写入公共能力阶梯，
 *   塔跟着板一起存在，板到点崩回原方块时等级一起收回。它是本族唯一**把防线放到世界里**的一招：
 *   别的三招改的是自己的身体，屏障改的是身前的地形。
 *
 ...
 *   gap        离身距离：基础 1.3 格 + 碰撞箱宽度×0.6，光屏再 +0.8；夹 1.1..3。身板越宽，墙立得越远，免得堵住自己。
 *   panels     光板数：基础 6 + 特攻/12 + 等级×0.1；夹 5..20。精神力越强，硬光板越多越密，粒子按它发射。
 ...
 * 配置 tall 双向取舍：关闭＝低而宽的壁垒，贴得近、拦得住从正面冲来的对手、护得更久，但不挡视线与远程，起手更慢；
 *   开启＝高而窄的光屏，立得远、挡得住视线与远程、起手更快，但窄得能被绕过、护得更短。两侧各有适用局面。
 */
namespace PokemonSkills {
    actionParameters.define("barrier", {
        ...
        gap: formula(
            ...
            "离身距离", {
                unit: " 格",
                description: "墙立在身前多远；身板越宽立得越远（免得堵住自己），光屏更远。"
            }),
        /** 光板数：精神力越强越多。 */
        panels: formula(
            ...
            "光板数", {
                unit: " 块",
                description: "拼成这面墙的硬光板数量；特攻与等级越高越多，粒子按它发射。"
            }),
        /** 屏障时长：防御与等级决定板能立多久。 */
        fieldTicks: seconds(
    ...
    describe("barrier", [
        ...
        { key: "description.2", values: ["panels"] },
