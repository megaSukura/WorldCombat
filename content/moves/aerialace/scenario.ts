 ...
 *
 * 场面：一只迅捷的斩击者对四格外的对手（掠袭距离之内，让它一步切到）。场地铺平，白天晴天。
 * 断言只取必然事实：这招被提交过、目标受过燕返伤害。刀数、暴击、命中路径上的额外目标写进 note 供读轨迹判断。
 */
Smoke.scenario("aerialace", function (stage) {
    ...
    stage.until(1000, function () {
        ...
        stage.after(80, function () {
            ...
            stage.note("cut count, crit, and whether the dash passed the foe are positional/random", {
