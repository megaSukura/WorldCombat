...
namespace PokemonSkills {
    ...
    define({
        ...
        name: "Overheat",
        description: "一次排空全身热量，在身前推出一张扇形热浪，主目标吃满、扇内其他人各吃一份并可能被点燃，落点留下焦痕；热量排空后自身特攻大幅下降。过载式单发更重，但自身特攻多掉一级、出手更慢。",
        uses: ["中近距离用一张扇形热浪同时烧到几个人", "把目标点着并在地上留下焦痕", "过载式用更重的单发与更大的自身消耗换一记爆发"],
        kind: "enemy",
        range: 8,
        maxRange: 12,
        prepare: 12,
