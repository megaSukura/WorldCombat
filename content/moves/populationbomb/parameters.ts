 ...
 *   身边集合（muster），然后一只接一只从目标四周扑过去，每只命中结算一小段 `swarm`；每只独立掷命中，
 *   一只扑空这一串就到此为止。所以这一串能拉多长不确定：可能是可怜的一下，也可能是一连十下。原生的
 *   回合制「1～10 次」被翻成一次出手里上限可变、随时可能断掉的连段。
 *
 ...
 *   flight   扑击速度：速度派生。
 *   reach    出动距离：等级与速度决定伙伴能扑多远，也是本招实际射程来源。
 *   radius   伙伴判定：身高决定一只伙伴扫过的范围。
 *   ring     集结半径：碰撞箱宽度决定从多远处扑来（画面里够不够四散）。
 *   lurk     扑击高度：身高决定从多高俯冲下来。
...
namespace PokemonSkills {
    actionParameters.define("populationbomb", {
        ...
        radius: formula(
            ...
            "伙伴判定", {
                unit: "格",
                description: "一只伙伴扑中目标算多大的擦碰范围；大个子叫来的伙伴身板也大。"
            }),
        ...
        ring: formula(
            ...
            "集结半径", {
                unit: "格",
                description: "伙伴从目标周围多远处一起扑来；身体越宽散得越开。画面里四散扑来的范围就是它。"
            }),
        ...
        lurk: formula(
            ...
            "扑击高度", {
                unit: "格",
                description: "伙伴从目标上方多高俯冲下来；大个子叫来的伙伴从更高处落。"
            }),
