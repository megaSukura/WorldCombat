 ...
 *   能量反冲回身体，特攻、特防、速度同时大涨。蓄力期间若被睡得/冻住，能量半途崩散、什么也拿不到。
 * 取原生「三攻三防项各 +2、PP 10、两回合」；放弃回合制里的等待回合——这里的第一拍是**插在地上的一段可见蓄力**，
 * 第二拍是地纹炸开的一刻。它是这一族里唯一的**两拍蓄力**，也是唯一把自己钉在地上、并在场上留下地纹的一招。
 *
 ...
 *   linger  基础 40 刻 + 碰撞箱高度 ×6，夹 30..60：地纹在爆发后还留一小会儿。
...
namespace PokemonSkills {
    actionParameters.define("geomancy", {
        ...
        linger: seconds(
            ...
            "地纹留存", "能量爆发后地纹还在地上亮多久；身板越大留得越久，到期原方块回来。"),
        /** 起式：速度决定扎地多快。 */
        tempo: seconds(
