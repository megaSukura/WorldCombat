...
Smoke.scenario("tripleaxel", function (stage) {
    ...
    stage.until(1200, function () {
        ...
        stage.note("each of the three kicks rolls its own accuracy (default 90%) and rises in power; the sweep angle defaults to 70 degrees and widens to 170 in sweep form", {
