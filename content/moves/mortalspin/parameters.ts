...
namespace PokemonSkills {
    actionParameters.define("mortalspin", {
        ...
        radius: formula(
            ...
            "晶光半径", {
                unit: "格",
                description: "原地旋一圈能把毒晶荡到多远；身板越宽、等级越高荡得越开，晶光式再放大一成五。它也是本招的实际射程与指示圈半径。"
            }),
        ...
        scatter: formula(
            ...
            "毒晶数量", {
                unit: "点",
                description: "旋转甩出的毒晶数量，随物攻与等级增长；粒子按它发射，画面里的数量与机制一致。"
            }),
