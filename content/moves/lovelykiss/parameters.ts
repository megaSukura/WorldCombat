 ...
 *
 * 世界化：把「用恐怖的脸强吻」翻成一记**贴地猛扑**——施法者先摆出一张恐怖的脸，再沿锁定方向贴地突进，
 *   用本体扫掠撞到的**第一个敌人**才是这一吻的对象，在真实接触点强吻下去，把人当场吓睡；撞墙或没碰到人
 *   就只收势，绝不远程下睡。它不隔空：必须先把身体送过去，所以走位与突进距离是它的读法；一旦贴到，命中
 *   很高，唯一能溜掉的是**比它更快**的目标（敏捷差进入成功率）。
 *
