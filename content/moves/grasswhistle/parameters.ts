 ...
 *   声音沿选定方向的直线扎出去：穿过路上第一个目标、继续扎进它背后的敌人。实心墙把音线截断在墙面，后段
 *   听不到；但声音不被生物挡住，穿过同伴的身体。一声就完，快而准；也可以朝空处吹。代价是这一声要么响、
...
namespace PokemonSkills {
    ...
    actionParameters.define(grasswhistleId, {
        ...
        reach: formula(
            ...
            "音束长度", {
                unit: " 格",
                description: "一声哨音能笔直送出多远；等级越高、特攻越强吹得越远。它也是本招的实际射程，沿选定的方向送出，实心墙会把音线截断在墙面。"
            }),
