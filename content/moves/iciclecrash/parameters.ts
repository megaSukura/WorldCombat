 ...
 * 翻译：把「用大冰柱激烈地撞向对手」翻成一根**从落点正上方坠落的大冰柱**——冰柱在落点上方凝成、竖直砸下，
 * 砸实的一瞬碎冰四散。它是单点重击，落点在出手时定死，对手可以在冰柱落下前走开；
 * 高空式更重、更能波及旁边，但落下更久、更好躲。与同族区分：岩崩是横扫一片的石头雨，龙卷风是立着的持续旋涡，
 * 怒火中烧是从自身炸开的气场；只有冰柱坠击是从天落到一个点上的单柱。
 *
 * 选取 `kind: "aim"`：点地面、点实体或点空处都成立，提交时不要求存在敌人；落点吸附到地面，出生柱尖按顶棚截短。
 *
