...
/** Native driver ownership and world action execution share the same sent-out Venusaur. */
        ...
        try {
            when (age++) {
                ...
                90 -> {
                    ...
                    println("P5CHECK PASS native riding, ranged world actions and control handover")
                }
            }
