...
**当前版本：0.1.0-alpha.3，公开测试版。** [下载与版本记录](https://github.com/megaSukura/WorldCombat/releases/tag/v0.1.0-alpha.3)。目标环境是 Minecraft 1.21.1 / NeoForge 21.1.250 / Java 21。正式内容已包含 756 个招式实现和 24 个特性单元；覆盖数量与实际体验成熟度分别看待，仍在持续打磨。
